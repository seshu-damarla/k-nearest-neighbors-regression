function [m,test] = spxy(X,y,Ncal)
% X--matrix of predictor variables
% Y--Response variable or quality variable
% Ncal--No.of samples to be selected for calibration set or training set
...
Dy = zeros(M,M); % Initializes the matriz de y-distances. 
for i = 1:M-1 
 xa = X(i,:); 
 ya = y(i,:); 
 for j = i + 1:M 
